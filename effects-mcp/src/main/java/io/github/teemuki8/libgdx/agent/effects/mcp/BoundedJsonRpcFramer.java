 ...
 * {@link EffectsProtocol#MAX_REQUEST_BYTES} bound protects actual stdio framing before any
...
public final class BoundedJsonRpcFramer {
    ...
    public static final int MAX_FRAME_BYTES = EffectsProtocol.MAX_REQUEST_BYTES;
